...
SocialRecommendationsRails::Application.config.session_store :cookie_store, :key => '_Social-Recommendations-Rails_session'

SocialRecommendationsRails::Application.config.session = {
...
# SocialRecommendationsRails::Application.config.session_store :active_record_store
